...
try {
	...
	String SQL = String.format("update users set password = '%s' where userID = %s;", newpasswd, userID);
	stmt = conn.createStatement();
	stmt.executeUpdate(SQL);
	SQL = String.format("update users set motto = '%s' where userID = %s;", newmotto, userID);
	stmt = conn.createStatement();
	stmt.executeUpdate(SQL);	
	SQL = String.format("update users set homePage = '%s' where userID = %s;", newhp, userID);
	stmt = conn.createStatement();
	stmt.executeUpdate(SQL);	
	if(newava!=null){
		SQL = String.format("update users set userAvatar = '%s' where userID = %s;", newava, userID);
		stmt.executeUpdate(SQL);
