...
<body>
    <div class="login-table">
        <div class="tit" style="margin-bottom: 22px">修改信息</div>
        ...
        <input id="password" name="password" required="required" type="password" placeholder="请输入新密码(不少于3位)">
        ...
        <br>
        <a href="javascript:;" class="a-upload" style="color: rgb(70, 137, 167);" id="ava_a">
            <input type="file" name="avatar" accept="image/*" id="avafile">上传头像
        </a>
...
<footer>
    <a href="home.jsp"><img src="medias/home.png" style="width: 30px;height: 30px; position: fixed; top: 20px; left: 30px;"></a>
</footer>
</html>
